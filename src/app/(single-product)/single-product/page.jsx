...
const SingleProduct = () => {
  ...
  const regularButtonClass =
    selectedButton === "Regular"
      ? "bg-[#3E5F41] p-4 rounded-lg"
      : "border p-4 text-black rounded-lg";

  const brownButtonClass =
    selectedButton === "Brown"
      ? "bg-[#3E5F41] p-4 rounded-lg"
      : "border p-4 text-black rounded-lg";
          ...
          <div className="w-3/6">
            ...
            <div class="mt-8 text-left">
              <h4 class="text-xs text-gray-500">
                Choose 6 different flavors of mini fatayer
              </h4>
            ...
            <div class="space-x-5 mt-8">
              <CommonButton
                ...
                onClick={() => setSelectedButton("Regular")}
              />
              <CommonButton
                type="submit"
                text="Brown Dough"
                className={brownButtonClass}
                onClick={() => setSelectedButton("Brown")}
              />
            </div>
          </div>
        </div>
